...
INSERT INTO transaction VALUES (2, '2024-07-10', '판매', '영양제', 700000 , 70000, '종합비타민');
INSERT INTO transaction VALUES (3, '2024-07-12', '판매', '영양제', 1200000 , 120000, '종합비타민');
INSERT INTO transaction VALUES (4, '2024-07-13', '구매', '책상', 4000000 , 0, '4대 구매');
INSERT INTO transaction VALUES (5, '2024-07-13', '구매', '노트북', 10000000 , 0, '4대 구매');
INSERT INTO transaction VALUES (6, '2024-07-17', '핀매', '의약외품', 2000000 , 200000, '소염진통제');
INSERT INTO transaction VALUES (7, '2024-07-18', '구매', '기타자재', 100000 , 0, '볼펜 및 노트');
INSERT INTO transaction VALUES (8, '2024-07-19', '핀매', '의약외품', 1500000 , 150000, '소염진통제');
INSERT INTO transaction VALUES (9, '2024-07-20', '핀매', '의료기구', 8000000 , 800000, '휠체어');
INSERT INTO transaction VALUES (10, '2024-07-21', '핀매', '영양제', 400000 , 40000, '오메가3');
...
-- BETWEEN a AND b : 좌항이 a 보다 크거나 같으면서 b 보다 작거나 같으면 true
-- NOT BETWEEN a AND b : 좌항이 a 보다 작거나 b 보다 크면 true
SELECT * FROM transaction
...
SELECT * FROM transaction
WHERE transaction_type = '판매' AND amount >= 150000;
