...
-- Error Code: 1055. Expression #2 of SELECT list is not in GROUP BY clause and contains nonaggregated column 'practice_sql.sale.date' which is not functionally dependent on columns in GROUP BY clause; this is incompatible with sql_mode=only_full_group_by
...
FROM sale
GROUP BY employee_number
HAVING AVG(amount) <= 110000; -- HAVING 평균 <= 110000;
